...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${productName} ${productRef ? `(${productRef})` : ""}`,
    ...
    openGraph: {
      ...
      description: product?.name
        ? `Achetez ${product.name} ${productRef} au meilleur prix. Livraison rapide en Tunisie.`
        : "Découvrez nos produits de qualité avec livraison rapide.",
...
async function ProductDetailData({ slug }) {
  ...
  const jsonLd = {
    ...
    brand: {
      "@type": "Brand",
      name: product.brand || "Smap Auto Pro",
    },
    offers: {
      "@type": "Offer",
      priceCurrency: "TND",
      ...
      url: `https://smap-auto-pro.vercel.app/p/${slug}`,
    },
  };
